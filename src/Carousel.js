...
function MyCarousel(){
    ...
    <Carousel.Item>
      ...
      <Carousel.Caption>
        ...
        <p>A couple of ways to look for questions relevant to your users is to scan online forums like Quora and Yahoo or to use the Google search bar. For example, if you search "consumer advertising distrust," Google will provide you with a list of questions (listed under the section " People also Ask"), such as "What are the 4 types of advertising?" This is a commonly searched question related to the keywords you've input — and a great basis for crafting content people will want to read or watch.
